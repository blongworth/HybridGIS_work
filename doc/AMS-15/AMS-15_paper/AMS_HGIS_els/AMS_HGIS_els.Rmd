...
```{r fig2, fig.width = 5, fig.height = 5, fig.align='center', out.width="80%", fig.cap = "\\label{fig2}Performance of the NOSAMS MCSNICS hybrid gas ion source. (a) Measured $^{12}C^-$ ion current during displacement of modern tank $CO_2$ from a sample vial with helium. (c) Modeled flows of helium and $CO_2$ to the ion source during the same dilution experiment.", echo = FALSE}
