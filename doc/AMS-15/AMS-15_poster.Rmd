...
1. 10-30mg Carbonate in septa-sealed 7mL vials
  - produces 2-6mL CO<sub>2</sub> @ ~1ATM
1. Evacuate and Acidify with 1 mL H3PO4 using automated Gilson prep bench
1. Add helium to 1 ATM
...
![HGIS Photo](images/gas_control.jpg)
![HGIS Photo](images/gilson.png)
...
Data from the measurement of consensus standards over a range of fraction modern shows that this simple correction is effective for removing blank contribution without bias.
...
ggplot() +
  ...
  geom_pointrange(aes(fm_mean, fm_diff, color = method, shape = method,
                      ...
                      ymax = fm_diff + sig_fm_corr),
                  position = "jitter") +
  geom_smooth(method = "lm", aes(fm_mean, fm_diff, color = method)) +
  scale_color_manual(values = c("#00b7bd", "#b7bf10")) +
  labs(title = "Haiti Core Graphite vs HGIS",
       x = "Mean Fm",
       y = "Fm - mean Fm")
