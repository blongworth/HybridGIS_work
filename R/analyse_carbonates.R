...
wheels <- c("020521", "030421", "040121", "041521", "051421", "052621", "061121", "061821", "062521", "062921")
files <- here("data", paste0("USAMS", wheels, "R.txt"))
dates <- as.Date(c("2021-02-05", "2021-03-05", "2021-04-09", "2021-04-16", "2021-05-14", "2021-05-28", "2021-06-11", "2021-06-18", "2021-06-25", "2021-07-02"))
stds <- list(c(5,8), NULL, c(26,37), NULL, c(10,15,65,70), NULL, NULL, NULL, NULL, NULL)
blanks <- list(7, c(7,8), c(28,29,30), c(27,28,29), c(20,35,50), NULL, NULL, 23, NULL, NULL)
