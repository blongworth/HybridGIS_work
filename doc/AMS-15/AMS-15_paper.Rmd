...
Currently, 250cm of 50um capillary defines flow rate from the open split into the source, with a bulkhead connector at the source cage.
...
Reference: gilson \@ref(Roberts 2013)
...
3.  Acquire data: 90s x 10 measurements.
