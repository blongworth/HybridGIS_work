...
Measurement of radiocarbon-free reference materials shows that the average normalized ratio for these samples is `r blankmean` ± `r blanksd` (N=`r nblank`). We investigated the sources of this method blank as a current-dependent blank and as a current-independent blank. 
