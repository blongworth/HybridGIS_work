...
We found the HGIS and graphite measurements to be in good agreement, with no significant bias over the range in F^14^C of the core samples (0.4 to 1.15) (Figure 5a). Mean difference between hybrid and graphite measurements was -0.003 F^14^C and the standard deviation of this difference was 0.009 F^14^C. Mean per-sample 1σ uncertainty was 0.010 F^14^C for HGIS measurements, compared with 0.002 F^14^C for graphite. There is an apparent, but not significant positive relationship between the HGIS-graphite difference and measured value. The higher graphite values at lower F^14^C may indicate an overcorrection of HGIS blank for these samples.
