...
Table: summary of reference materials

figure5: difference plot
...
significant bias (figure 6). Mean per-sample error was 1 pMC for HGIS measurements, 
compared with 0.3 pMC for graphite.
...
Figure6: bland-altman of HGIS vs graphite.
