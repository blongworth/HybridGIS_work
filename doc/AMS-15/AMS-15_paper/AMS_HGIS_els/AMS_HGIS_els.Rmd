...
```{r fig1, fig.width = 5, fig.height = 5, fig.align='center', out.width="80%", fig.cap = "\\label{fig1}Schematic of the open split inlet. The double needle is housed in a tee fitting and allows displacement helium to flow into the sample vial and the sample-helium mixture to flow to the open split, where a capillary delivers the mixture to the ion source.", echo = FALSE}
