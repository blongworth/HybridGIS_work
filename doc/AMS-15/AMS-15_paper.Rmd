...
250cm of 50um capillary defines flow rate from the open split into the source, with a bulkhead connector at the source cage.
...
Process blank samples were prepared from powdered C-1 or TIRI-F. Standards were prepared using the automated gas handling system by evacuating vials prior to filling with 1 ATM of a modern standard gas.
