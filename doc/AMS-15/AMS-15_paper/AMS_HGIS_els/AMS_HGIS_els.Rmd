...
The HGIS method produced higher ratios for radiocarbon dead samples than the graphite method. The average normalized ratio for radiocarbon-free reference materials IAEA C1 marble and TIRI F spar calcite was `r blankmean` ± `r blanksd` (1$\sigma$ uncertainty, N=`r nblank`). We investigated the sources of this method blank as a current-dependent blank and as a current-independent blank, and implemented a blank correction for the method.
