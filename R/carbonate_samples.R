...
cd11 <- tribble(~pos, ~name, ~rec_num, ~mass, ~he_added,
                    10, "C-1_1", 83028, 15.01, 4,      
                    22, "C-1_2", 83028, 15.13, 4,      
                     6, "6:7_39-40", 171996, 16.12, 1,  
                     7, "4:7_10-11", 171992, 16.54, 3,  
                     8, "1:1_12-13", 171987, 18.33, 2.2,  
                     9, "1:1_81_82", 171988, 15.89, 3.2,  
                    12, "2:7_90-91", 171989, 16.97, 3,  
                    13, "3:7_25-26", 171990, 16.12, 3.2,  
                    14, "3:7_73-74", 171991, 17.37, 2.8,  
                    15, "4:7_95-96", 171993, 17.32, 3,  
                    17, "5:7_57-58", 171994, 14.91, 4,  
                    18, "5:7_108-109", 171995, 16.08, 3,
                    19, "7:7_8-9", 172000, 15.95, 2,    
                    20, "7:7_47-48", 172001, 16.09, 2,  
                    23, "6:7_60-61", 171997, 16.09, 3.6,  
                    24, "6:7_90-91", 171998, 18.37, 2.6,  
                    25, "6:7_120-121", 171999, 15.36, 4) %>% 
  mutate(wheel = "USAMS062921")
                

carb_data <- bind_rows(cd1, cd2, cd3, cd4, cd5, cd6, cd7, cd8, cd9, cd10, cd11) %>% 
