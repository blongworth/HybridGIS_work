...
Fig. 1. Performance of the NOSAMS MCSNICS hybrid gas ion source. 

Fig. 2. Assessment of blanks. (a) Current dependent blank. (b) Fraction modern of large, radiocarbon dead samples compared to sample current. Blank rises with decreasing current, as expected, but may be treated as a single blank with a simple correction for full-size samples producing greater than XX uA C- current.

Fig. 3. Relationship of sample size to C- ion current. There is no strong relationship between size and current for samples larger than XX ug C.

Fig 4. Agreement of standards with graphite consensus values. 

Fig 5. Comparison of Haiti core samples measured as graphite.